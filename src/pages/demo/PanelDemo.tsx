  ...
  return (
    <div className="grid">
      <div className="col-12">
        <div className="card">
          <h5>Toolbar</h5>
          <Toolbar left={toolbarLeftTemplate} right={toolbarRightTemplate} />
        </div>
      </div>
          ...
          <div className="grid">
            ...
            <div className="col-5 align-items-center justify-content-center">
              ...
              <p>
                ...
                vel volutpat ipsum. Integer nunc magna, posuere ut tincidunt
                eget, egestas vitae sapien. Morbi dapibus luctus odio.
              </p>
            </div>
          </div>
        </div>
