...
const OverlayDemo = () => {
  ...
  const toggleDataTable = (event: MouseEvent<HTMLButtonElement>) => {
    op2.current.toggle(event);
  };

  const onProductSelect = (event: DataTableSelectParams) => {
    op2.current.hide();
    toast.current.show({
      severity: "info",
  ...
  const imageBodyTemplate = (data: Product) => (
    <Picture
            ...
            <div className="flex flex-wrap gap-2">
              <div>
                ...
                <OverlayPanel
                  ...
                  showCloseIcon
                >
                  <Picture src={`/images/nature/nature9.jpg`} alt="nature1" />
                </OverlayPanel>
              </div>
              <div>
                <Button
