        ...
        <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
          ...
          >
            ...
            <div className="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
              <Button
                label="Login"
                className="p-button-text p-button-rounded border-none font-light line-height-2 text-blue-500"
              />
              <Button
                label="Register"
                className="p-button-rounded border-none ml-5 font-light line-height-2 bg-blue-500 text-white"
              />
            </div>
          </div>
        </div>
        ...
        >
          <div className="mx-4 md:mx-8 mt-0 md:mt-4">
            <h1 className="text-6xl font-bold text-gray-900 line-height-2">
              <span className="font-light block">Eu sem integer</span>eget magna
              fermentum
            </h1>
          ...
          <div className="grid justify-content-center">
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-users text-2xl text-yellow-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-palette text-2xl text-cyan-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-map text-2xl text-indigo-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-id-card text-2xl text-bluegray-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-star text-2xl text-orange-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-moon text-2xl text-pink-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-shopping-cart text-2xl text-teal-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-globe text-2xl text-blue-700" />
                  </div>
            ...
            <div className="col-12 md:col-12 lg:col-4 p-0 lg-4 mt-4 lg:mt-0">
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="pi pi-fw pi-eye text-2xl text-purple-700" />
                  </div>
            ...
            >
              <div className="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                ...
                <Picture
                  src={`/images/landing/peak-logo.svg`}
                  className="mt-4"
                  alt="Company logo"
                />
              </div>
        ...
        <div id="highlights" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
          ...
          <div className="grid mt-8 pb-2 md:pb-8">
            ...
            <div className="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
              ...
              >
                <i className="pi pi-fw pi-mobile text-5xl text-purple-700" />
              </div>
          ...
          <div className="grid my-8 pt-2 md:pt-8">
            <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
              ...
              >
                <i className="pi pi-fw pi-desktop text-5xl text-yellow-700" />
              </div>
              <h2 className="line-height-1 text-900 text-4xl font-normal">
            ...
            >
              <Picture
                src={`/images/landing/mockup-desktop.svg`}
                className="w-11"
                alt="mockup"
              />
            </div>
            ...
            <div className="col-12 lg:col-4 p-0 md:p-3">
              <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                ...
                <div className="my-5 text-center">
                  ...
                  <Button
                    label="Get Started"
                    className="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light line-height-2 bg-blue-500 text-white"
                  />
                </div>
                <Divider className="w-full bg-surface-200" />
                <ul className="my-5 list-none p-0 flex text-900 flex-column">
                  <li className="py-2">
                    <i className="pi pi-fw pi-check text-xl text-cyan-500 mr-2" />
              ...
              <div className="grid text-center md:text-left">
                ...
                <div className="col-12 md:col-3 mt-4 md:mt-0">
                  ...
                  <a className="line-height-3 text-xl block cursor-pointer mb-2 text-700">
                    Events
                    <Picture
                      src={`/images/landing/new-badge.svg`}
                      className="ml-2"
                      alt="new badge"
                    />
                  </a>
