...
import BlockViewer from "../../../components/utils/BlockViewer";
...
<div className="grid grid-nogutter surface-section text-800">
    ...
    <div className="col-12 md:col-6 overflow-hidden">
        <Picture  src="demo/images/blocks/hero/hero-1.png" alt="hero-1" className="md:ml-auto block md:h-full" style={{ clipPath: 'polygon(8% 0, 100% 0%, 100% 100%, 0 100%)' }} />
    </div>
</div>
    `;
...
<div className="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div className="text-700 text-center">
        <div className="text-blue-600 font-bold mb-3"><i className="pi pi-discord" />&nbsp;POWERED BY DISCORD</div>
...
<div className="bg-bluegray-900 text-gray-100 p-3 flex justify-content-between lg:justify-content-center align-items-center flex-wrap">
    <div className="font-bold mr-8"><span role="Image" aria-label="fire">🔥</span> Hot Deals!</div>
...
<div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
    <div className="text-center mb-5">
        <Picture  src="demo/images/blocks/logos/hyper.svg" alt="hyper" height="50" className="mb-3" />
    ...
    <div>
        ...
        <div className="flex align-items-center justify-content-between mb-6">
            <div className="flex align-items-center">
                <Checkbox inputId="rememberme1" binary="true" className="mr-2" onChange={e => setChecked(e.checked)} checked={checked} />
...
<div className="surface-card p-4 shadow-2 border-round">
    ...
    <div style={{ height: '150px' }} className="border-2 border-dashed surface-border" />
</div>
    `;
  ...
  return (
    <>
      ...
      <BlockViewer
        header="Banner"
        code={block5}
        containerClassName="surface-section py-8"
      >
        <div className="bg-bluegray-900 text-gray-100 p-3 flex justify-content-between lg:justify-content-center align-items-center flex-wrap">
          <div className="font-bold mr-8">
            <span role="Image" aria-label="fire">
              🔥
            </span>{" "}
            Hot Deals!
          </div>
      ...
      <BlockViewer header="Page Heading" code={block6}>
        <div className="surface-section px-4 py-5 md:px-6 lg:px-8">
          <ul className="list-none p-0 m-0 flex align-items-center font-medium mb-3">
            <li>
              <button className="p-link text-500 no-underline line-height-3 cursor-pointer">
                Application
              </button>
            </li>
            <li className="px-2">
      ...
      <BlockViewer
        header="Sign-In"
        code={block8}
        containerClassName="surface-ground px-4 py-8 md:px-6 lg:px-8 flex align-items-center justify-content-center"
      >
        <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
          <div className="text-center mb-5">
            <Picture
