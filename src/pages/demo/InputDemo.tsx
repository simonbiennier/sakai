...
export const InputDemo = () => {
  ...
  const [autoValue, setAutoValue] = useState<Option[]>([]);
  const [selectedAutoValue, setSelectedAutoValue] = useState(null);
  const [autoFilteredValue, setAutoFilteredValue] = useState<Option[]>([]);
  const [calendarValue, setCalendarValue] = useState<CalendarValueType>(null!);
  const [inputNumberValue, setInputNumberValue] = useState<number>();
  const [chipsValue, setChipsValue] = useState<Option[]>([]);
  ...
  const [selectedNode, setSelectedNode] = useState<TreeSelectSelectionKeys>();
  const [treeSelectNodes, setTreeSelectNodes] = useState(null);

  const listboxValues: Option[] = [
  ...
  const multiselectValues: Option[] = [
  ...
  const selectButtonValues1: Option[] = [
      ...
      <div className="col-12 md:col-6">
        <div className="card">
          ...
          <InputNumber
            ...
            onValueChange={(e) => setInputNumberValue(e.value || 0)}
            showButtons
            mode="decimal"
          />
        ...
        <div className="card">
          <div className="grid">
            ...
            <div className="col-12 md:col-6">
              ...
              <ColorPicker
                value={colorValue}
                onChange={(e) => setColorValue(e.value as string)}
                style={{ width: "2rem" }}
              />
            </div>
            <div className="col-12">
              ...
              <div className="p-inputgroup">
                <span className="p-inputgroup-addon p-inputgroup-addon-checkbox">
                  <Checkbox
                    ...
                    onChange={(e) => setInputGroupValue(e.checked)}
                  />
                </span>
